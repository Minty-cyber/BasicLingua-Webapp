    ...
    document.getElementById("process-button").addEventListener("click", function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                document.getElementById("corrected-result").innerHTML = "<h4>Extraction Result</h4><p style='text-align: left; max-width: 100%; overflow-wrap: break-word;'>" + response.answer + "</p>";
            },
