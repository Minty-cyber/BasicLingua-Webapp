    ...
    document.getElementById("process-button").addEventListener("click", function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                document.getElementById("corrected-result").innerHTML = "<h4>Corrected Text</h4><p style='text-align: left; max-width: 100%; overflow-wrap: break-word;'>" + response.intent + "</p>";
            },
