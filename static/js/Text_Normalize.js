...
document.getElementById("summarize-button").addEventListener("click", function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            document.getElementById("summary-result").innerHTML = "<h4>Transformed Text</h4><p style='text-align: left; max-width: 100%; overflow-wrap: break-word;'>" + response.transformed_text + "</p>";
        },
