...
document.getElementById("process-button").addEventListener("click", function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            document.getElementById("processed-result").innerHTML = "<h4>Text Replacement Result</h4><p style='text-align: left; max-width: 100%; overflow-wrap: break-word;'>" + response.corrected_text + "</p>";
        },
